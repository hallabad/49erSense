...
public class SocketTestClient {
    ...
    public SocketTestClient(String i_IPAddr, int i_port){
        try{
        ...
        while(!line.equals("e")||!line.equals("E")){
            try{
                ...
                System.out.println("[Error] There was an issue reading from the consol");
            }
        }
        try{
            ...
            System.out.println("[Error] There was an issue closing the socket connection");
        }
    }
    public static void main(String[] args) throws Exception {
        SocketTestClient client = new SocketTestClient("192.168.5.149", 5000);
    }
}
